## Tenda AC15 15.03.05.19_multi firmware has a buffer overflow vulnerability in the form_fast_setting_wifi_set

There is a serious buffer overflow vulnerability in the `form_fast_setting_wifi_set` function of Tenda router AC15 15.03.05.19_multi firmware. Attackers can use `sscanf(timestr + 1, "%[^:]:%s", timespand, timespand[1], 0, 0)` to cause a denial of service attack, or even cause the service to crash and execute malicious code.

![image-20250329210225266](README/image-20250329210225266.png)
...
![image-20250329211531838](README/image-20250329211531838.png)